...
data = pd.read_csv('C:/Users/LENOVO/Downloads/guvi/mrt.csv')
...
if selected == "About Project":
    ...
    st.markdown("### :blue[Technologies :] Python, Pandas, Numpy, Scikit-Learn, Streamlit, Python scripting, "
                ...
                "Model Deployment")
    st.markdown("### :blue[Overview :] This project aims to do prediction model based on past transactions "
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r"C:/Users/LENOVO/Downloads/guvi/model.pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r'C:/Users/LENOVO/Downloads/guvi/scaler.pkl', 'rb') as f:
                ...
                data = pd.read_csv('C:/Users/LENOVO/Downloads/guvi/df_coordinates.csv')
